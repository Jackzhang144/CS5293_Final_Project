...
Recent work on many-shot jailbreaking \cite{anil2024manyshot} demonstrates that extending context windows can introduce new vulnerabilities, where filling the context with many examples of a harmful behavior can诱导 the model to replicate that behavior.
...
\hline
Method & Effectiveness & Overhead & Generalization \\ \hline
Input Filtering & Moderate & Low & Low \\ \hline
Output Filtering & Moderate & Medium & Low \\ \hline
Constitutional AI & High & High & Medium \\ \hline
SmoothLLM & High & Medium & Medium \\ \hline
Constitutional Classifiers & Very High & High & High \\ \hline
\end{tabular}
\end{table}
